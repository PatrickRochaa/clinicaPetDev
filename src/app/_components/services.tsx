...
export function Services() {
  ...
  /* ====================================================== */
  //funçao de passar e voltar os sliders
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {services.map((item, index) => (
                ...
                >
                  {/*cada elemento do carousel*/}
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-2 h-full flex flex-col select-none">
                    <div className="flex-1 flex items-start justify-between">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-smc my-1">
                            {item.description}
                          </p>
                        </div>
                      </div>
                    ...
                    {/*Container tempo do serviço*/}
                    <div className="border-t border-gray-700 pt-4 flex items-center gap-2 justify-between">
                      {/*Icone e tempo */}
                      ...
                      {/*Butao  WhatsApp*/}
                      <a
                        href={`https://wa.me/5531985385297?text=Olá vim pelo site e gostaria de mais informações sobre ${item.title}`}
